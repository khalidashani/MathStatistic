...
header-includes:
  - \usepackage{lscape}  # Include the landscape package
  - \geometry{landscape, margin=1in}  # Set landscape orientation and 1-inch margins
geometry: margin=1in, landscape  # Set page margins and landscape orientation
---
